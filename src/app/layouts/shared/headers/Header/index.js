...
const Header = () => {
    ...
    const ConnectButton = () => {
        ...
        if (account) return <Button sx={{pt:3, pb: 3}}  variant="contained"  onClick={() => deactivate()}>Disconnect</Button>
        else return <Button sx={{pt:3, pb: 3}}  variant="contained" onClick={() => activateBrowserWallet()}>Connect</Button>
      }
